...
select_PartIIcontent_151P0_partII_Value_type(__attribute__((unused)) const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
...
static asn_TYPE_member_t asn_MBR_partII_Value_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PartIIcontent_151P0__partII_Value, choice.VehicleSafetyExtensions),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PartIIcontent_151P0__partII_Value, choice.SpecialVehicleExtensions),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PartIIcontent_151P0__partII_Value, choice.SupplementalVehicleExtensions),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static asn_CHOICE_specifics_t asn_SPC_partII_Value_specs_3 = {
	sizeof(struct PartIIcontent_151P0__partII_Value),
	offsetof(struct PartIIcontent_151P0__partII_Value, _asn_ctx),
	offsetof(struct PartIIcontent_151P0__partII_Value, present),
	sizeof(((struct PartIIcontent_151P0__partII_Value *)0)->present),
...
asn_TYPE_member_t asn_MBR_PartIIcontent_151P0_1[] = {
	...
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct PartIIcontent_151P0, partII_Value),
		...
		select_PartIIcontent_151P0_partII_Value_type,
